...
if __name__ == '__main__':
    ...
    dSeuilDistance = 60.  # Distance max pour association
    ...
    for file in os.listdir("."):
        if file.endswith(".avi"):
            ...
            while ret and iKey != 27:  # touche 'Echap'
                # Acquerir l'image
                ret, data = cap.read()
                ...
                if ret:
                    ...
                    cvImg = cv2.cvtColor(imgFlip, cv2.COLOR_BGR2GRAY)
